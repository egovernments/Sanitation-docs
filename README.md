...
DIGIT Sanitation aims to ensure zero untreated waste by catalysing open digital ecosystems.

## Overview

DIGIT Sanitation is an open-source web and mobile-enabled platform designed to digitise operations in the waste management value chain, from collection to treatment, and provides the ability to drive coordination across multiple independent and disconnected stakeholders. This ensures that there is a continued chain of custody of waste throughout.&#x20;
...
1. Allowing citizens to request fo r septic tank desludging services.
...
[Faecal Sludge Management (FSM)](product/faecal-sludge-management-fsm/)

## Programme

Click [here](programme/#sujog-feacal-sludge-and-septage-management-fssm) to know more about our SUJOG-Faecal Sludge & Septage Management (FSSM) programme in Odisha.
